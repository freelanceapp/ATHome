...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyHolder> {
    ...
    public CartAdapter(List<BankDataModel.BankModel> bankDataModelList, Context context) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        CartRowBinding bankRowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.cart_row, parent, false);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        private CartRowBinding bankRowBinding;

        public MyHolder(CartRowBinding bankRowBinding) {
